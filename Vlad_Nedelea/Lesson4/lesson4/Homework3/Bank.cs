...
namespace Homework3
{
    ...
    public class Bank : IBank
    {
        public ArrayList GenerateFinancialTransactions(int numberOfTransactions)
        {
            ...
            Person person_from_default = new Person(3, "person3", new DateTime(10 / 10 / 1876));
            Person person_to_default = new Person(5, "person5", new DateTime(10 / 10 / 1678));
            ...
            for(int i = 0; i < numberOfTransactions; i++)
            {
                ...
                if (i % 3 == 0)
                {
                    person_from = person_from_default;                 
                }

                if (i % 5 == 0)
                {
                    person_to = person_to_default;
                }
